...
public interface InsuranceMapper                                       
{
	...
	public List<InsuranceDTO> selectInsuranceList(Criteria criteria);                   // selectInsuranceList       :: SELECT 쿼리 호출 메서드 (게시글 목록 조회)
	public int selectInsuranceTotalCount(Criteria criteria);                            // selectInsuranceTotalCount :: SELECT 쿼리 호출 메서드 (삭제여부[delete_yn)가 'N'으로 지정된 게시글 개수 조회)
}
